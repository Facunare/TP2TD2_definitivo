...
// nivel actual. Al llegar al último carácter, marca el nodo como el final de la palabra y guarda la palabra
...
// a este nodo. Esto permite obtener una lista de palabras que coinciden con el prefijo.
...
// encontradas en el arreglo de strings, segun se especifique. La idea principal es recorrer los nodos y, al llegar a un nodo que marca el fin
// de una palabra, decidir si se debe contar la palabra o almacenarla en el arreglo.
...
// Si un nodo corresponde a una palabra, también se libera su memoria.
